    ...
    content: [
      {
        ...
        teamRecruitBody:
          '<p dir="ltr"><span style="font-size: 18px;">스터디</span><br/><span style="font-size: 18px;">스터디</span>내용길게내용길게내용길게내용길게내용길게내용길게내용길게내용길게내용길게내용길게내용길게내용길게내용길게내용길게내용길게내용길게내용길게내용길게</p>',
        memberNickName: '파댕이',
        isRecruiting: false,
        teamId: 10,
